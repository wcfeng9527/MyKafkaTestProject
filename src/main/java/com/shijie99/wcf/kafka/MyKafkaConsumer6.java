...
public class MyKafkaConsumer6 {
	public static void main(String[] args) throws Exception{
		...
		//auto.offset.reset这里设置为earliest，是为了consumer能够从头开始读取内容即offset=0开始
...
//	    consumer.subscribe(Arrays.asList(topic));
	    //consumer.seekToBeginning也可以设置offset
//	    consumer.seekToBeginning(partition0, partition1);
		while(true) {
			System.out.println("当前位置:"+consumer.position(partition1));
